...
function CodexyIntro({ onDone }: { onDone: () => void }) {
  ...
  const dataDots = [
    { x: -360, y: -160, delay: 0.18 },
    { x: 340, y: -130, delay: 0.26 },
    { x: -280, y: 180, delay: 0.34 },
    { x: 300, y: 170, delay: 0.42 },
    { x: 0, y: -260, delay: 0.5 },
    { x: 0, y: 260, delay: 0.58 },
  ]
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.7, delay: 2.15, ease: 'easeOut' }}
        >
          <strong>CODEXY</strong>
          <span>Prospect</span>
        </motion.div>
...
function CodexySignalMark() {
  const pathTransition = { duration: 0.9, ease: 'easeInOut' as const }

  return (
    <motion.svg className="signal-mark" viewBox="0 0 220 220" role="img" aria-label="Logo Codexy">
      <defs>
        ...
        <linearGradient id="signal-blue" x1="20" x2="200" y1="20" y2="200">
          <stop offset="0" stopColor="#8bc5ff" />
          <stop offset="0.48" stopColor="#0055ff" />
      ...
      <motion.rect
        ...
        height="160"
        rx="32"
        fill="rgba(7,12,28,0.88)"
        stroke="rgba(139,197,255,0.68)"
        strokeWidth="2"
        filter="url(#signal-glow)"
        initial={{ pathLength: 0, opacity: 0 }}
        animate={{ pathLength: 1, opacity: 1 }}
        transition={{ ...pathTransition, delay: 0.65 }}
      />
      <motion.path
        d="M48 50H172"
        className="signal-path-blue signal-path-cap"
      ...
      <motion.path
        d="M48 170H172"
        className="signal-path-muted signal-path-cap"
        initial={{ pathLength: 0 }}
        animate={{ pathLength: 1 }}
        transition={{ ...pathTransition, delay: 1.1 }}
      />
      <motion.path
        d="M70 73L107 110L70 147"
        className="signal-path-white signal-path-cap"
        initial={{ pathLength: 0, opacity: 0 }}
        animate={{ pathLength: 1, opacity: 1 }}
        transition={{ ...pathTransition, delay: 1.32 }}
      />
      <motion.path
        d="M116 73L153 110L116 147"
        className="signal-path-blue signal-path-cap"
        initial={{ pathLength: 0, opacity: 0 }}
        animate={{ pathLength: 1, opacity: 1 }}
        transition={{ ...pathTransition, delay: 1.48 }}
      />
      <motion.circle
        cx="110"
        cy="110"
        ...
        animate={{ opacity: [0, 1, 0.85], scale: [0.4, 2.1, 1] }}
        transition={{ duration: 0.75, delay: 1.95, ease: 'easeOut' }}
      />
    </motion.svg>
  )
}
